...
// to intercept any page.goto() requests in all our tests. If the specific request goes to
// our protected prod and staging sites, the fixture adds the needed authentication headers
// in the GET request to gain access to the site.
// If the page.goto() request goes to another site, we don't add the headers
// to avoid leaking them to a 3rd party.
//
